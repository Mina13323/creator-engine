# Graph Report - CEO  (2026-06-15)

## Corpus Check
- 115 files · ~61,336 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 982 nodes · 1075 edges · 97 communities (71 shown, 26 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 18 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6d8d9317`
...
Cohesion: 0.08
Nodes (42): AppPage(), PROTECTED_TABS, AuthModal(), BrandingPanel(), BusinessPlanDashboard(), CofounderChat(), Dashboard(), MarketingDashboard() (+34 more)
...
Cohesion: 0.06
Nodes (35): AgentRun, AuthResponse, AuthUser, BrandIdentity, BrandIdentityModel, BusinessIdea, BusinessIdeaModel, BusinessModel (+27 more)
...
Cohesion: 0.13
Nodes (21): KnowledgeDocument, AGENT_PROMPTS, callLLM(), embedText(), KNOWLEDGE_BASE, KnowledgeDocument, orchestrateVentureBuilder(), parseLLMJson() (+13 more)
...
Cohesion: 0.13
Nodes (14): active, connections, Fireworks AI, Parse JSON, Tavily Search, Webhook, main, name (+6 more)

### Community 91 - "Community 91"
Cohesion: 0.15
Nodes (12): active, connections, Fireworks AI, Parse JSON, Webhook, main, name, nodes (+4 more)
...
## Knowledge Gaps
- **580 isolated node(s):** `PreToolUse`, `name`, `version`, `private`, `main` (+575 more)
...
- **Should `Langflow Tools` be split into smaller, more focused modules?**
