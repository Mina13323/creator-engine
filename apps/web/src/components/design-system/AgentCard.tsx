    ...
    <Card hoverable className="flex flex-col">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <div className="flex items-center space-x-3">
          <div className="bg-[#e4f3ee] p-2 rounded-full ring-1 ring-[#ccede3]">
            <Bot className="w-5 h-5 text-[#008465]" />
          </div>
      ...
      <CardContent className="flex-1 pt-4">
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-1.5">
              {outputs.map(o => (
                <span key={o} className="text-xs bg-[#e4f3ee] text-[#008465] px-2 py-1 rounded-md">{o}</span>
              ))}
            </div>
          </div>
        ...
        <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-100">
          ...
          <Button variant="ghost" size="sm" onClick={onViewDetails} className="text-[#008465] px-0 hover:text-[#007055] hover:bg-transparent">
            View Details
