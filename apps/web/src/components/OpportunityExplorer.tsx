                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {isSelected && (
                          <span className="px-2.5 py-0.5 bg-emerald-50 text-emerald-700 text-xs font-semibold rounded-full border border-emerald-200 flex items-center gap-1">
                            <CheckCircle className="w-3 h-3 text-emerald-600" /> Active Concept
                          </span>
                        )}
                      </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 mt-2">
                Selecting this opportunity will replace your current startup concept. Any generated business plans or details under the old concept will be overwritten.
              </p>
            </div>
            <div className="flex justify-end gap-3 pt-2">
              <Button variant="ghost" className="rounded-xl" onClick={() => setConfirmingOppId(null)}>Cancel</Button>
